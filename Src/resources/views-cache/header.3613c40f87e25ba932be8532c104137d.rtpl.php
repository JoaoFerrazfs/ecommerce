...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/Src/resources/base-templates/site/css/bootstrap.min.css">
    ...
    <link rel="stylesheet" href="/Src/resources/base-templates/site/css/style.css">
    <link rel="stylesheet" href="/Src/resources/base-templates/site/css/responsive.css">
...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="#"><img src="/Src/resources/base-templates/site/img/logo.png"></a></h1>
                </div>
            </div>
