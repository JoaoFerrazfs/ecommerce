...
(/** @lends <global> */function( $ ) {
	...
	/**
	 * PageSiteController change event, fired when the paging of the table is altered.
	...
	/**
	 * PageSiteController length change event, fired when number of records to show on each
