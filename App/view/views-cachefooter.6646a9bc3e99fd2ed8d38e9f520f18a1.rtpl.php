...
<!-- jQuery sticky menu -->
<script src="/App/view/resource/site/js/owl.carousel.min.js"></script>
<script src="/App/view/resource/site/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/App/view/resource/site/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/App/view/resource/site/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/App/view/resource/site/js/bxslider.min.js"></script>
<script type="text/javascript" src="/App/view/resource/site/js/script.slider.js"></script>
</body>
</html>